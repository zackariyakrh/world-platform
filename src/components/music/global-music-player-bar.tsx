...
export function GlobalMusicPlayerBar() {
  ...
  return (
    <>
      ...
      {/* Bottom Player Bar */}
      <div className={cn("shrink-0 border-t", isDark ? "bg-gray-900 border-white/[0.06]" : "bg-white border-gray-200")} style={{ boxShadow: isDark ? "0 -6px 40px rgba(120,60,200,0.25), 0 -2px 16px rgba(120,60,200,0.15), 0 -4px 24px rgba(0,0,0,0.4)" : "0 -4px 32px rgba(120,60,200,0.1), 0 -2px 12px rgba(0,0,0,0.06)" }}>
        {/* Progress bar */}
